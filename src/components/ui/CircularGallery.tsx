...
class Media {
  ...
  width = 0; widthTotal = 0; x = 0; padding = 0; scale = 1
...
class App {
  ...
  renderer!: any; gl!: any; camera!: any; scene!: any
  planeGeometry!: any; medias: Media[] = []
  screen = { width: 0, height: 0 }
  viewport = { width: 0, height: 0 }
  isDown = false; start = 0; raf = 0
  boundOnResize: any; boundOnWheel: any
  boundOnTouchDown: any; boundOnTouchMove: any; boundOnTouchUp: any

  constructor(container: HTMLElement, { items, bend, textColor = '#ffffff', borderRadius = 0, font = 'bold 30px sans-serif', scrollSpeed = 2, scrollEase = 0.05 }: any) {
  ...
  createMedias(items: CircularGalleryItem[], bend = 1, textColor: string, borderRadius: number, font: string) {
    ...
    this.medias = doubled.map((data, index) =>
      new Media({
        ...
        length: doubled.length, renderer: this.renderer, scene: this.scene,
  ...
  onWheel(e: WheelEvent) {
    const delta = (e as any).deltaY || (e as any).wheelDelta || (e as any).detail
