      ...
      <div className="mx-auto max-w-xl px-6">
        ...
        <div className="text-center mb-12">
          ...
          >
            Inizia il vostro
            <br />
            <span className="text-gradient-gold">viaggio insieme</span>
          </motion.h2>
          <motion.p
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <button
              ...
              style={{
                ...
                background: submitted ? '#e0d8cc' : '#c9a96e',
                color: submitted ? '#b5a898' : '#ffffff',
                display: 'flex',
                alignItems: 'center',
              ...
              onMouseEnter={(e) => {
                if (!loading && !submitted) e.currentTarget.style.background = '#e8d5b0'
              }}
              onMouseLeave={(e) => {
                if (!loading && !submitted) e.currentTarget.style.background = '#c9a96e'
              }}
            >
              {loading ? (
                <>
